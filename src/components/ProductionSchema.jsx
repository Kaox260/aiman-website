...
function ProductionSchema() {
  ...
  return (
    <div className="article-container mt-16 px-4 gap-y-2 mb-24">
      ...
      <div className="flex flex-wrap justify-center items-center gap-8 mt-12">
        {steps.map((step, index) => (
          ...
          >
            <div className="flex flex-col items-center w-[240px] relative">
              {index === 0 && (
                <div
                  className={`w-5 h-5 rounded-full border-2 ${step.color ? step.color : ""
                    } z-10`}
                ></div>
              )}

              <div className="bg-white mt-4 p-4 rounded-xl shadow-md border border-gray-200 text-center">
      ...
      <div className="flex justify-center" ref={finalRef}>
        <div className="flex flex-col items-center w-[260px] text-center">
          <FestiveCircle />
          <div className="bg-white mt-4 p-4 rounded-xl shadow-md border border-gray-200">
